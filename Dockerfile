...
WORKDIR /home/app
COPY ./build/libs/mn-asterisms-hibernate-reactive-0.1-all.jar /home/app/application.jar
...
RUN keytool --importcert -file /home/certificates/asterisms_local.crt -alias "asterisms.local" -cacerts -storepass changeit -noprompt
